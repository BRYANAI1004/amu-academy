...
function LearnPageShell({ children }: { children: ReactNode }) {
  return (
    <div className="portal-page amu-gradient-page learn-page student-portal-page student-learn-page">
      <AmuGradientArt />
      {children}
    </div>
  )
  ...
  if (loading) {
    return (
      <LearnPageShell>
        ...
        <div className="student-portal-shell learn-portal-shell">
          <div className="student-portal-scroll-area learn-scroll-area">
...
function LearnPageContent({ course, error }: { course: ApiCourse; error: string | null }) {
  ...
  return (
    <LearnPageShell>
      ...
      <div className="student-portal-shell learn-portal-shell">
        {error && (
          <p className="portal-api-notice learn-api-notice" role="status">
            {error}
          </p>
        )}
            ...
            <main className="learn-main">
              <div className="video-section">
                ...
                <article className="lesson-detail">
                  ...
                  <div className="lesson-actions lesson-actions--inline">
                    {lessonActions}
                  </div>
        ...
        <footer className="student-portal-footer learn-mobile-footer">
